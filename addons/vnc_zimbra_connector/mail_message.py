...
class mail_message(osv.Model):
    ...
    _message_read_fields = ['id', 'parent_id', 'model', 'res_id', 'body', 'subject', 'date', 'to_read', 'email_from','email_to','email_cc',
        'type', 'vote_user_ids', 'attachment_ids', 'author_id', 'partner_ids', 'record_name']
    _columns = {
        'email_to': fields.char('To',
            help="Email address of the Receiver. This field is set when no matching partner is found for incoming emails."),
